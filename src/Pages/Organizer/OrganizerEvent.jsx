...
import SelectLocat from '../../Assets/Image/selectLocation.webp';
import Logo3 from '../../Assets/Image/logoTest.png'
...
const OrganizerEvent = () => {
	...
	return (
		<Container fluid>
			<section className='homeEvent findEvent organizer'>
				<Row className='w-100 d-flex justify-content-center align-items-center flex-column'>
					<Col lg={3} className='organizerLogo'>
						<img src={Logo3} alt='logo' />
					</Col>
					<Col lg={12}>
						<h3 className='w-100 text-white text-center KanitRegular organizerTitle'><u>North Brunswick Youth Sports Festival</u></h3>
					</Col>
				</Row>
