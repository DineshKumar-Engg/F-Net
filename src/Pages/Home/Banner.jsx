		...
		<Container fluid className='homebannerCont'>
			<section className='Homebanner'>
				<Carousel fade slide={false} interval={null}>
					<Carousel.Item>
						<img className='Carousel-items-set' src={BannerOne} alt='First slide' />
					</Carousel.Item>
					<Carousel.Item>
						<img className='Carousel-items-set' src={BannerTwo} alt='First slide' />
					</Carousel.Item>
					<Carousel.Item>
						<img className='Carousel-items-set' src={BannerThree} alt='First slide' />
					</Carousel.Item>
					<Carousel.Item>
						<img className=' Carousel-items-set' src={BannerFour} alt='Second slide' />
					</Carousel.Item>
					<Carousel.Item>
						<img className=' Carousel-items-set' src={BannerFive} alt='Third slide' />
					</Carousel.Item>
					<Carousel.Item>
						<img className=' Carousel-items-set' src={BannerSix} alt='Third slide' />
					</Carousel.Item>
					<Carousel.Item>
						<img className=' Carousel-items-set' src={BannerSeven} alt='Third slide' />
					</Carousel.Item>
					<div className='container-fluid bannerMarquee'>
						<Marquee>
							<h5>
								Festival Season Is Here !!! Stay Tuned ! Festival Season Is Here !!!
								Stay Tuned ! Festival Season Is Here !!! Stay Tuned ! Festival
								Season Is Here !!! Stay Tuned ! Festival Season Is Here !!! Stay
								Tuned !
							</h5>
						</Marquee>
					</div>
