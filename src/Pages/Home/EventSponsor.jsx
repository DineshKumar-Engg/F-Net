        ...
        <Container>
          <Row className="CardEventTemplateRow">
            <Col lg={3} className="CardEventTemplate">
              ...
              {/* <div className="eventSponsorLabelContainer">
               <div className="d-flex align-items-ceneter flex-row">
               <div className="SponsorLable">
                  <p className="mb-0">SPONSORS</p>
                </div>
               </div>
                <img src={EventSponsorLogo} alt="EventSponsorLogo" className="SponsorLogo" />
              </div> */}
              <Row>
